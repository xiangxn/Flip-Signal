...
//
// 检测 Polymarket UP/DOWN 价格穿越 0.7 后 10 秒内的反转信号（docs/strategy_plan_2026-08-31.md）:
//
...
type Tick struct {
	...
	UpBid     float64 // UP 最优买价
	UpAsk     float64 // UP 最优卖价
	DownBid   float64 // DOWN 最优买价
	DownAsk   float64 // DOWN 最优卖价
