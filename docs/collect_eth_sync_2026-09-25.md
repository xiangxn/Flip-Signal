...
> ✅ **2026-09-25 已复核（服务器数据 23 窗）：见 `docs/eth_data_review_2026-09-25.md`
> 与决策 #25。**「现象为真」得到确认（30 段 / 21.5% 的 tick，段起点与市场定局精确耦合
> ⇒ 本机网络假设排除）；「比率」仍是**上界性质的指示**（未做 REST 双通道复核，
> 且持有空快照的时间可能长于市场实际）。本节以下原文保留作为发现问题时的记录。
