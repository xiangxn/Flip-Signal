...
#
# Usage:
#   ./build.sh                    # build cmd/lab for linux/amd64
#   ./build.sh <name>             # build cmd/<name> for linux/amd64
#   ./build.sh <name> <arch>      # build cmd/<name> for linux/<arch>
#   ./build.sh amd64              # build cmd/lab for linux/amd64 (legacy)
#   ./build.sh arm64              # build cmd/lab for linux/arm64 (legacy)
#   ./build.sh --clean            # remove dist/
#
# Available commands: flip, lab, mqs, test_resolve
# ============================================================
set -euo pipefail
...
echo "  scp $DIST_DIR/$CMD user@host:/usr/local/bin/"
echo ""
echo "Run on Ubuntu:"
echo "  ./$CMD"
